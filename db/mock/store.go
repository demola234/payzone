...
// Source: github.com/demola234/payzone/db/sqlc (interfaces: Store)
...
func (m *MockStore) ListAccountsByOwner(arg0 context.Context, arg1 db.ListAccountsByOwnerParams) ([]db.Accounts, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccountBalance(arg0 context.Context, arg1 db.UpdateAccountBalanceParams) (db.Accounts, error) {
	m.ctrl.T.Helper()
