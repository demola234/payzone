...
func generateRandomAccountWithOwnersName(t *testing.T, ownerID int64, ownerName string) db.Accounts {
	return db.Accounts{
		
	}
}

func generateRandomAccountsByOwner(t *testing.T, ownerID int64) []db.Accounts {
	var accounts []db.Accounts
	for i := 0; i < 10; i++ {
		accounts = append(accounts, generateRandomAccount(t, ownerID))
	}
	return accounts
}
