...
func (server *Server) setUpRouter() {
	...
	router.POST("/users/checkUsername", server.checkUsernameExists)
	router.POST("/users/renewAccess", server.renewAccessToken)
	...
	authRoutes.GET("/entries", server.listUserEntires)
