...
func TestGetAccount(t *testing.T) {
	...
	account2, err := testQueries.GetAccount(context.Background(), account.O)
...
func TestDeleteAccount(t *testing.T) {
	...
	account2, err := testQueries.GetAccount(context.Background(), account.Owner)
	require.Error(t, err)
...
func TestListAccountsForUser(t *testing.T) {
	user := createRandomUser(t)
	account := createRandomAccountsForUser(t, user)
	require.Len(t, account, 4)
